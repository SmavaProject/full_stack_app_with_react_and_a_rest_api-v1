...
export default class UpdateCourse extends Component {
    ...
    updateCourse = () => {
        ...
        context.data.updateCourse(id, updatedCourse, emailAddress, password).then(errors => {
            if(errors.length){
                this.setState({
                    errors: errors
                })
                              ...
                              <React.Fragment>
                                  <div className="grid-66">
                                      ...
                                      <div className="course--description">
                                          <div>
                                                  <textarea id="description" name="description" className="" onChange={this.onChange} value={description}></textarea>
                                          </div>
                                      </div>
                                  </div>
                                          ...
                                          <ul className="course--stats--list">
                                              <li className="course--stats--list--item">
                                                  ...
                                                  <div><input id="estimatedTime" name="estimatedTime" type="text"
                                                              className="course--time--input" onChange={this.onChange} value={estimatedTime}/></div>
                                              </li>
                                              <li className="course--stats--list--item">
                                                  <h4>Materials Needed</h4>
                                                  <div><textarea id="materialsNeeded" name="materialsNeeded"
                                                                 className="" onChange={this.onChange} value={materialsNeeded}></textarea></div>
                                              </li>
                                          </ul>
                                      </div>
                                  </div>
